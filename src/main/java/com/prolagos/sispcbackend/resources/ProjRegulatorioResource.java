...
public class ProjRegulatorioResource {
	...
	@Autowired
    private ProjDelibRegulatorioService delibservice;
    ...
    @RequestMapping(value="/{revisaoId}/delibregulatorios", method=RequestMethod.GET)
	public ResponseEntity<List<Cad_Projetos_DeliberacoesRegulatorios>> findByRevisao(@PathVariable Integer revisaoId) {
		List<Cad_Projetos_DeliberacoesRegulatorios> list = delibservice.findByRevisao(revisaoId);
