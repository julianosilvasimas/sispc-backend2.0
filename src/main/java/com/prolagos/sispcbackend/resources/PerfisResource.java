...
public class PerfisResource {
	...
	public ResponseEntity<Cad_SisPC_Perfis> find(@PathVariable Integer id) {
	...
	public ResponseEntity<Void> update(@RequestBody Cad_SisPC_Perfis obj, @PathVariable Integer id) {
		obj.setPerfilId(id);
	...
	public ResponseEntity<List<Cad_SisPC_Perfis>> findAll() {
		List<Cad_SisPC_Perfis> list = service.findAll();
		return ResponseEntity.ok().body(list);
	}
	
	@RequestMapping(value="/page", method=RequestMethod.GET)
	public ResponseEntity<Page<Cad_SisPC_Perfis>> findPage(
			@RequestParam(value="page", defaultValue="0") Integer page, 
			@RequestParam(value="linesPerPage", defaultValue="24") Integer linesPerPage, 
			@RequestParam(value="orderBy", defaultValue="perfilId") String orderBy, 
			@RequestParam(value="direction", defaultValue="ASC") String direction) {
		Page<Cad_SisPC_Perfis> list = service.findPage(page, linesPerPage, orderBy, direction);
		return ResponseEntity.ok().body(list);
	}
